 ...
 *   https://datatables.net/download/#dt/dt-1.11.4/b-2.2.2/date-1.1.1/r-2.2.9/sl-1.3.4
 *
 * Included libraries:
 *   DataTables 1.11.4, Buttons 2.2.2, DateTime 1.1.1, Responsive 2.2.9, Select 1.3.4
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.11.4/b-2.2.2/date-1.1.1/r-2.2.9/sl-1.3.4",
